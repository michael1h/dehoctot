...
export class BaiTestComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.isLoading = true;
    this.http.get(URLAPI  + 'part1', {}, {}).then(data => {
      ...
      if (this.baiTests) {
        ...
        this.goiY = this.baiTests.listen.listening[this.indexCauHoi].listQuestion[0].goiY;
        this.giaiThich = this.baiTests.listen.listening[this.indexCauHoi].listQuestion[0].giaiThich;
        this.cauDung = this.baiTests.listen.listening[this.indexCauHoi].listQuestion[0].cauDung;
  ...
  kiemTra() {
    ...
    const dapAnDung = this.baiTests.listen.listening[this.indexCauHoi].listQuestion[0].cauDung;
